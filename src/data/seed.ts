...
export const projects: Project[] = [
  {
    ...
    apiEndpoints: [
      ...
      {
        method: 'GET',
        path: '/api/v1/projects/adros-core/schema',
        description: 'Retrieve normalized relational schema tables and relationships for Adros Core.',
        sampleResponse: [
          {
            name: 'Courses',
            columns: [
              { name: 'Id', type: 'uniqueidentifier', isPrimaryKey: true },
              { name: 'Title', type: 'nvarchar(200)', isPrimaryKey: false },
              { name: 'InstructorId', type: 'uniqueidentifier', isPrimaryKey: false },
            ],
            relationships: [],
          },
        ],
